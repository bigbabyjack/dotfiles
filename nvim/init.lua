-- See `:help mapleader`
vim.g.python3_host_prog = '/Users/jcjc/.pyenv/shims/python3'
    ...
    config = function()
      require('lualine').setup {
        ...
        sections = {
          ...
          lualine_x = { { 'datetime', style = 'default' }, 'encoding', 'fileformat', 'filetype' },
          lualine_y = { 'progress' },
          lualine_z = { 'location' },
        },
      }
...
vim.keymap.set('n', '<leader>zz', '<cmd>lua require("zen-mode").toggle()<CR>', { desc = 'Toggle [Z]en mode' })
